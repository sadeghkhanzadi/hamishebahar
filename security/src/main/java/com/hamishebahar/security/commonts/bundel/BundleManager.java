package com.hamishebahar.security.commonts.bundel;
...
// First load to the cache if not already loaded
    ...
    public static String getMessage(String key, Locale locale) {
        try {
            ...
            log.error("Resource key : " + key + " not found because : " + e);
            return key;
        }
    }
        ...
        if (content != null && content.length() > 0) {
            ...
            for (String wrappedKey : wrappedKeys) {
                ...
                try {
                    ...
                    log.error(String.format("Cannot translate text : %s", content));
                    return content;
                }
            }
            return result;
