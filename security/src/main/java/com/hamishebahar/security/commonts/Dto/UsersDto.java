...
public class UsersDto {
    ...
    public UsersDto updaterFields(UsersDto dto) {
        return new UsersDto.Builder()
                ...
                .Email(getEmail() != null && !getEmail().isEmpty() ? getEmail() : dto.getEmail())
                .PhoneNumber(getPhoneNumber() != null && !getPhoneNumber().isEmpty() ? getPhoneNumber() : dto.getPhoneNumber())
                .NationalCode(getNationalCode() != null && !getNationalCode().isEmpty() ? getNationalCode() : dto.getNationalCode())
                .Password(getPassword() != null && !getPassword().isEmpty() ? new BCryptPasswordEncoder().encode(getPassword()) : dto.getPassword())
                .Name(getName() != null && !getName().isEmpty() ? getName() : dto.getName())
                .Picture(getPicture() != null && !getPicture().isEmpty() ? getPicture() : dto.getPicture())
