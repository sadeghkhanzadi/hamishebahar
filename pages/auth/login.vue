  ...
  <form action="" class="w-full sm:w-2/3 lg:w-1/2 xl:w-2/5 mx-auto border rounded-lg p-5 py-7" @submit.prevent="handleSubmit">
    ...
    <div class="flex flex-col gap-4 mb-4">
      <div class="form-group flex flex-col  gap-3 ">
        ...
        <input id="userName" type="text" v-model="form.userName" @keydown="error.userName.length ? error.userName = '' : ''" class="w-full border-0 outline-0 border-b px-5 text-sm">
      ...
      <div class="form-group flex flex-col relative gap-3 ">
        ...
        <input :type="password" v-model="form.password" id="password" @keydown="error.password.length ? error.password = '' : ''" class="w-full border-0 outline-0 border-b px-5 text-sm" >
