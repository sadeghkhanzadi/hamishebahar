...
function handleSubmit() {
  if (params.backgroundColor.length < 3) {
    paramsError.backgroundColor = true
  }
  if (params.color.length < 3) {
    paramsError.color = true
  }
    ...
    <div class="modal-icons mt-[15vh] mx-auto md:w-1/2 lg:w-1/3 2xl:w-1/5 bg-white p-5 rounded ">
      <form action="" class="flex flex-col gap-3" @submit.prevent="handleSubmit">
        ...
        <div class="input-group flex flex-col gap-2 ">
          ...
          <input v-model.trim="params.icon" class="px-3 py-1 text-sm rounded outline-0 border-[rgba(0,0,0,0.15]"
                 type="text" id="icon">
        ...
        <div class="input-group flex flex-col gap-2 ">
          ...
          <input v-model.trim="params.color" class="px-3 py-1 text-sm rounded outline-0 border-[rgba(0,0,0,0.15]"
                 type="text" id="color">
        ...
        <div class="input-group flex flex-col gap-2 ">
          ...
          <input v-model.trim="params.backgroundColor" @keydown="paramsError.backgroundColor=false"
                 class="px-3 py-1 text-sm rounded outline-0 border-[rgba(0,0,0,0.15]" type="text" id="background-color">
